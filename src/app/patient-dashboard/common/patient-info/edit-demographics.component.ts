    ...
    this.subscription = this.patientService.currentlyLoadedPatient.subscribe(
      (patient) => {
        ...
        if (patient) {
          ...
          this.testPatientValue = patient.person.ifTestPatient as any;
    ...
    if (this.errors.length === 0) {
      ...
      const personNamePayload = {
        ...
        attributes: [
          ...
          {
            value: this.testPatientValue,
            attributeType: "1e38f1ca-4257-4a03-ad5d-f4d972074e69",
          },
        ],
      };
