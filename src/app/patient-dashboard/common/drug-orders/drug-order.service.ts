...
export class DrugOrderService {
 ...
 const drugSearchResults: BehaviorSubject<any> = new BehaviorSubject<any>([]);
  ...
  public PharmacyDrugInfo(name){
    const url= 'http://localhost:55013/api/Product/GetProductByName/' + name;
     return this.http.get(url)
  }
  public PostToPharmacy(payload){
    const url = 'http://localhost:55013/api/Prescription/add';
