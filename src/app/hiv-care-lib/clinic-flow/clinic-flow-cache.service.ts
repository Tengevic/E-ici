...
export class ClinicFlowCacheService {
  ...
  public lastClinicFlowMaxSelectedDate: any;
  ...
  public maxFormatedDate = Moment(new Date()).format("YYYY-MM-DD");
  public maxSelectedDate = new BehaviorSubject(this.formatedDate);
  ...
  public setMaxSelectedDate(date) {
    this.maxFormatedDate = Moment(date).format("YYYY-MM-DD");
    this.lastClinicFlowMaxSelectedDate = this.maxFormatedDate;
    this.setIsLoading(true);
    this.maxSelectedDate.next(this.maxFormatedDate);
  }
  public getSelectedDate() {
    return this.selectedDate;
  }
  public getmaxSelectedDate() {
