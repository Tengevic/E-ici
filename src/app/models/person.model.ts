...
export class Person extends BaseModel {
  ...
  public get patnerPhoneNumber() {
    const patnerPhoneNumberPersonAttributeTypeUuid =
      "b0a08406-09c0-4f8b-8cb5-b22b6d4a8e46";
    if (this._attributes) {
      const patnerPhoneNumber = this.getPersonAttribute(
        patnerPhoneNumberPersonAttributeTypeUuid
      );
  ...
  public get ifTestPatient() {
    const PersonAttributeTypeUuid = "1e38f1ca-4257-4a03-ad5d-f4d972074e69";
    if (this._attributes) {
      const personAttribute = this.getPersonAttribute(PersonAttributeTypeUuid);
      if (personAttribute) {
        return personAttribute;
  ...
  public get levelOfEducation() {
    const levelOfEducationPersonAttributeTypeUuid =
      "18fa9439-1725-457e-b92e-d80d59843ee2";
